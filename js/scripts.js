...
$(document).ready(
    ...
    function(){
        $('#show_norbButton').click(
            function(){
                $('#we').show();
                $('#hide_norbButton').show();
                $('#show_norbButton').hide();
                
            }
        );
        $('#hide_norbButton').click(
            function(){
                $('#we').hide();
                $('#show_norbButton').show();
                $('#hide_norbButton').hide();
